...
### Qué contiene el EPUB

- **Cuento 1: *Tor og hammeren*** ("Thor y el martillo"). Cómo Thor consigue su martillo *Mjølnir*, el arma más poderosa del Asgard. Versión adaptada al A1 del relato del *Skáldskaparmál*.
- **Cuento 2: *Odins to ravner*** ("Los dos cuervos de Odín"). El relato de Huginn y Muninn, los dos cuervos que vuelan por el mundo y traen a Odín noticias cada noche. Versión adaptada del *Gylfaginning*.
- **Cuento 3: *Loki og fisken*** ("Loki y el pez"). Cómo Loki, escapando de los demás dioses, se transforma en salmón y termina inventando, sin querer, la red de pescar. Versión adaptada del *Skáldskaparmál*.
...
1. *¿Qué te trajo al curso?*
2. *¿Qué te gustaría poder hacer al terminarlo?*
3. *¿Qué creías que iba a ser lo más difícil?*

Léelas otra vez. Y ahora **escribe tres frases nuevas**:

4. **¿Has conseguido lo que querías?** (Sí, no, parcialmente — sé honesto/a.)
...
- **Snorri Sturluson** (siglo XIII). *Den yngre Edda* (Edda en prosa). Las adaptaciones de los tres microcuentos parten de las traducciones al noruego moderno editadas por Anne Holtsmark (Aschehoug, 2003), reescritas y simplificadas para nivel A1 por la autora.
- **Universitetet i Bergen — Norrøn filologi**. Recursos académicos sobre los mitos nórdicos.
- **Norsk Folkemuseum** (Museo Popular Noruego). Material divulgativo sobre la pervivencia de la mitología nórdica en la cultura contemporánea.
- Faulkes, A. (Ed.). (1995). *Edda* (versión inglesa de referencia). Everyman. (Verificación cruzada de los relatos del *Gylfaginning* y *Skáldskaparmál*).
- **NDLA** (Nasjonal digital læringsarena). Materiales para la asignatura *Norsk* sobre los días de la semana y su origen mitológico.
- Para la conexión entre Tyr, Tiw y el martes en lenguas germánicas: **Det Norske Akademis ordbok** (NAOB), entradas etimológicas. [naob.no](https://naob.no)
