...
➡️ **Abrir el cuestionario**: [quiz-comida.qti.zip](quiz-comida.qti.zip)

> 📌 **Nota técnica**: igual que en L2, el cuestionario está en formato **IMS QTI** (estándar interoperable). Importable a Moodle, Canvas y otros LMS. La clave de respuestas viene incluida en el ZIP para que puedas autoevaluarte sin necesidad de plataforma.
...
- **5 ejercicios de vocabulario**: relaciona la palabra noruega con la imagen.
...
➡️ **Descargar el cuadernillo**: [ejercicios-mat-og-drikke.pdf](ejercicios.pdf)
...
➡️ **Continuar a [L5 · *Familie og fritid* — Familia y tiempo libre](../L5-familie-og-fritid/)**
